...
plt.title('Trajectory of 1kg Cannon Ball',fontsize=20)
...
plt.xlabel('Horizontal Distance',fontsize=18)
plt.ylabel('Height',fontsize=18)
plt.title('Trajectories of Cannon Balls of Various Masses',fontsize=20)
plt.tick_params(axis='both',labelsize=16)
...
plt.title('Distance Travelled of Cannonballs of Different Masses',fontsize=20)
plt.tick_params(axis='both',labelsize=16)
plt.show()